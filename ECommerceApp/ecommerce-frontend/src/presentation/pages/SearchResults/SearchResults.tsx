...
const productDatabase: Product[] = [
  {
    ...
    category: "otc",
    description:
      "Ibuprofen 200mg is an over-the-counter medication for temporary relief of minor aches and pains.",
    inStock: true,
  ...
  },
  {
    ...
    category: "otc",
    description:
      "Acetaminophen 300mg is an over-the-counter medication for temporary relief of minor aches and pains.",
    inStock: true,
    requiresPrescription: false,
  ...
  },
  {
    ...
    category: "otc",
    description:
      "Aspirin 400mg is an over-the-counter medication for temporary relief of minor aches and pains.",
    inStock: true,
    requiresPrescription: false,
  ...
  },
  {
    ...
    description:
      "Levothyroxine is a prescription medication used to treat hypothyroidism.",
    inStock: true,
  ...
  },
  {
    ...
    category: "vitamins",
    description:
      "Vitamin D3 supplements help maintain bone health and immune function.",
    inStock: true,
    requiresPrescription: false,
    ...
    const results = productDatabase.filter((product) => {
      return (
        ...
        (product.manufacturer &&
          product.manufacturer.toLowerCase().includes(trimmedQuery)) ||
...
const SearchResults: React.FC = () => {
  ...
  const [showPrescriptionOnly, setShowPrescriptionOnly] =
