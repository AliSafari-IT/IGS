...
namespace IGSPharma.Application.Interfaces
{
    public interface IChangelogService
    {
        ...
        Task<ApiResponse<ChangelogDto>> UpdateChangelogAsync(string id, UpdateChangelogDto updateChangelogDto);
        Task<ApiResponse<bool>> DeleteChangelogAsync(string id);
        Task<ApiResponse<ChangelogDto>> SaveFileAsync(string path, string content, string username);
    }
}
