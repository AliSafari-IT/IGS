...
const MarkdownDisplay = lazy(
  () => import("../MarkdownDisplay/MarkdownDisplay")
);
...
const ChangelogFilesViewer: React.FC<ChangelogFilesViewerProps> = ({
  isOpen,
  onClose,
}) => {
  ...
  const handleDeleteFile = async (id: string) => {
    if (
      window.confirm(
        "Are you sure you want to delete this changelog file? This action cannot be undone."
      )
    ) {
      try {
        ...
        <div className="changelog-files-header">
          ...
          <div className="changelog-files-actions">
            ...
            <button
              ...
              title={
                sortOrder === "desc" ? "Sorteer oplopend" : "Sorteer aflopend"
              }
            >
              <i
          ...
          {isLoading ? (
            <div className="changelog-loading-container">
              <div className="changelog-loading">
                <i className="fas fa-spinner fa-spin"></i> Loading changelog
                files...
              </div>
            </div>
          ) : error ? (
                      ...
                      >
                        ...
                        <div className="changelog-file-info">
                          ...
                          <div className="changelog-file-meta">
                            <span className="changelog-file-version">
                              {file.version}
                            </span>
                            <span className="changelog-file-date">
                              {file.date}
                            </span>
                            <span className="changelog-file-size">
                              {file.size}
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="changelog-pagination">
                      ...
                      {Array.from({ length: totalPages }, (_, i) => i + 1).map(
                        (page) => (
                          <button
                            key={page}
                            className={`changelog-pagination-page ${
